  ...
  return (
    <SafeAreaView className="flex-1 bg-dark-bg" edges={["top"]}>
      <View className="px-5 pt-2 pb-4">
        <Text className="text-white text-2xl font-bold mb-4">Resources</Text>
          ...
          {US_STATES.map((state) => (
            <TouchableOpacity
              ...
              className={`mr-2 px-4 py-2 rounded-full ${
                selectedState === state ? "bg-violet-accent" : "bg-dark-card"
              }`}
              activeOpacity={0.7}
            >
              <Text
          ...
          >
            <Card className="mb-3">
              <View className="flex-row items-start">
                <View className="w-10 h-10 rounded-full bg-violet-accent/20 items-center justify-center mr-3">
